...
public class MapChunk extends Group {
	...
	private static AStarGridFinder<GridCell> pathFinder = new AStarGridFinder<GridCell>(GridCell.class, new GridFinderOptions(false, true, new ManhattanDistance(), false, 1f, 0));
	...
	public void loadFromMap(TiledMap map){
		...
		navigation = new NavigationGrid<GridCell>(cells);
