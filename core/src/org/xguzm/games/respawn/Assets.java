...
public class Assets {
	...
	private static void loadTempGraphics(){
		...
		playerUp.setPlayMode(PlayMode.LOOP);
		...
		playerLeft.setPlayMode(PlayMode.LOOP);
		...
		playerDown.setPlayMode(PlayMode.LOOP);
		...
		playerRight.setPlayMode(PlayMode.LOOP);
		...
		animations.put("flag", new Animation(0.1f, getAtlas().findRegions("flag"), PlayMode.LOOP));
	}
